use std::cmp::min;
use crate::editor::annotated_string::annotated_string_part::AnnotatedStringPart;
...
impl<'a> Iterator for AnnotatedStringIterator<'a> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        if let Some(annotation) = self.annotated_string.annotations.iter()
            .filter(|annotation| {
            ...
            return Some(AnnotatedStringPart {
                ...
                annotated_type: Some(annotation.annotation_type),
            });
        }
