...
use crate::prelude::{ColIdx, GraphemeIdx, RowIdx, Size};
...
impl CommandBar {
    ...
    pub fn handle_edit_command(&mut self, command: Edit) {
        match command {
            ...
            Edit::DeleteLine | Edit::DeleteToLineStart | Edit::Replace(_) | Edit::YankLine | Edit::Paste | Edit::PasteAbove | Edit::Undo | Edit::Redo | Edit::DeleteToNextWordStart
            | Edit::DeleteRangeToMove(_) | Edit::YankRangeToMove(_) | Edit::ChangeRangeToMove(_)
            | Edit::JoinLines | Edit::ToggleCase | Edit::RepeatLastEdit | Edit::Indent | Edit::Deindent
            | Edit::DeleteSelection | Edit::YankSelection | Edit::ToggleCaseSelection | Edit::ReplaceWithYank | Edit::YankInnerWord => {}
        }
